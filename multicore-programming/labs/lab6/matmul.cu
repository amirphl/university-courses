...
__global__ void maatrixMulCUDA_1(float *C, float *A, float *B, int n){
	int k;
...
__global__ void matrixMulCUDA_2_1(float *C, float *A, float *B, int n)
{
...
__global__ void matrixMulCUDA_2_2(float *C, float *A, float *B, int n)
{
...
int matrixMultiply(int argc, char **argv, int n)
{
	...
	//matrixMulCUDA_3 <<< 4, threads>>> (d_C, d_A, d_B, n);
	matrixMulCUDA_2_1 <<< DimGrid, DimBlock>>> (d_C, d_A, d_B, n);
...
void print(float* h_C, float* h_A, float* h_B, int n){
